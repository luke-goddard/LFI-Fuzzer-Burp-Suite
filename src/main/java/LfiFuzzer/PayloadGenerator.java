...
/**
 * This class uses the configuration generated by the user interface to
 * tailor the payloads that are generated.
 */
public class PayloadGenerator {
    ...
    private Set<byte []> generateFilePayloads(){
        ...
        for (String fileToInclude : config.filesToInclude) filePayloads.add(fileToInclude.getBytes());
        return filePayloads;
    }
    ...
    private Set<byte[]> swapSlashes(String direction){
        ...
        for(byte[] oldPayload: payloads){
            newPayload = new byte[oldPayload.length];
